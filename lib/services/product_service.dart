...
class ProductService {
  ...
  Future<void> logDamagedAction(int produitId, String produitNom, int quantite, String action, String utilisateur) async {
    final db = await database;
  ...
  Future<void> declareDamaged(Produit produit, int quantite) async {
    ...
    await logDamagedAction(produit.id, produit.nom, quantite, 'declare', 'Admin');
  }
